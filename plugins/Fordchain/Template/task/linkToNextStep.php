<? if ($task['owner_id'] == $this->user->getId() && $task['column_id'] == 8): ?>
    <div class="btn btn-red" style="float: right;"><?= $this->modal->small('close','>Close', 'FordchainController', 'nextChainStepConfirm', array('plugin' => 'Fordchain', 'task_id' => $task['id'], 'project_id' => $task['project_id']),false,"popover");?></div>
